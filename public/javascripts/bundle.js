...
var loadavg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loadavg'); // WebSocketのオブジェクトをsocket.io-clientモジュールから読み込む


var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_1___default()('http://localhost:8000'); // ローカルホストに接続することで作成
